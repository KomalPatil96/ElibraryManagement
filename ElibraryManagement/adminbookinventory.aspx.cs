...
namespace ElibraryManagement
{
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        void deleteBookByID()
        {
            ...
            {
                Response.Write("<script>alert('Invalid Books ID ');</script>");
            }
        }
        void updateBookByID()
        {
        ...
        bool checkIfBookExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * FROM book_master_tbl Where book_id='" + TextBox1.Text.Trim() + "' OR book_name='"+ TextBox1.Text.Trim() + "';", con);
